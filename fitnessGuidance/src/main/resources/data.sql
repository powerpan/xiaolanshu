...
MERGE INTO exerciseguides (
    actionpattern, actionname, equipment, description, steps, tips, imageurl
) KEY(actionpattern, equipment) VALUES
('水平推', '俯卧撑', '徒手', '训练胸、肩前束和肱三头肌的基础推类动作。重点是身体保持一条直线，推起时不要耸肩。', '双手略宽于肩，手掌在胸口两侧|脚尖踩地，收紧腹部和臀部|吸气下降到胸部接近地面|呼气推起，肘部不要完全锁死', '腰不要塌，肩胛保持稳定|如果标准俯卧撑困难，可以先做跪姿俯卧撑|下降速度慢一点，比追求次数更重要', '/exercise-guides/push-up.svg'),
('垂直拉', '毛巾下拉', '徒手', '模拟垂直拉的背部训练，用毛巾或弹力带练习肩胛下沉和背阔肌发力。', '双手握住毛巾两端并保持张力|先让肩膀远离耳朵，肩胛向下|肘部向身体两侧下拉|慢慢回到起始位，不要耸肩', '先找背部夹紧和下沉感觉|动作不要用腰后仰代偿|有弹力带时可以替换成弹力带下拉', '/exercise-guides/vertical-pull.svg'),
('下肢蹲', '徒手深蹲', '徒手', '训练股四头肌、臀部和基础下肢控制能力。适合大多数训练计划作为下肢主动作。', '双脚与肩同宽，脚尖自然外展|臀部向后向下坐，膝盖跟随脚尖方向|下蹲到能稳定控制的位置|脚跟踩稳，呼气站起并收紧臀部', '膝盖不要内扣|背部保持自然挺直|宁可深度浅一点，也不要失去控制', '/exercise-guides/squat.svg'),
('核心', '平板支撑', '徒手', '训练腹部抗伸展能力，帮助稳定腰椎和提升整体动作质量。', '手肘位于肩膀正下方|脚尖踩地，身体从头到脚成一直线|收紧腹部和臀部|保持均匀呼吸直到规定时间', '不要塌腰或撅臀|脖子保持自然，不要抬头|腰酸明显时先缩短时间', '/exercise-guides/plank.svg'),
('下肢硬拉', '髋铰链早安式', '徒手', '练习髋关节主导的发力模式，强化臀腿后侧和硬拉动作基础。', '双脚与髋同宽，双手可放胸前|膝盖微屈，臀部向后推|背部保持中立，躯干前倾|感到臀腿后侧拉伸后，用臀部带动站起', '不是弯腰，而是髋向后折叠|全程保持背部自然平直|先练动作轨迹，再增加负重', '/exercise-guides/hip-hinge.svg'),
('垂直推', 'Pike 俯卧撑', '徒手', '偏向肩部和肱三头肌的垂直推训练，是徒手肩推的基础版本。', '双手撑地，臀部抬高形成倒 V|头部向双手之间下降|手掌推地，身体回到起始位|全程保持肩部稳定和核心收紧', '下降时肘部自然向后外侧|不要把重量全部压到脖子|难度过高可缩短动作幅度', '/exercise-guides/pike-push-up.svg'),
('弯举', '毛巾阻力弯举', '徒手', '训练肱二头肌控制和手臂屈曲力量，可用毛巾制造自我阻力。', '双手抓住毛巾两端，一手提供向下阻力|另一手做弯举动作|顶端停顿一秒|慢慢放下并保持张力', '阻力由自己控制，不要突然发力|上臂尽量固定在身体两侧|左右手都要完成同样组数', '/exercise-guides/towel-curl.svg'),
('臂屈伸', '椅上臂屈伸', '徒手', '训练肱三头肌和肩部稳定能力，适合作为上肢推训练的辅助动作。', '双手撑在稳固椅沿，手指朝前|双脚踩地，身体靠近椅子|肘部向后弯曲让身体下降|手掌发力推回起始位', '肩膀远离耳朵|下降幅度以肩部舒服为准|椅子必须稳固，避免滑动', '/exercise-guides/chair-dip.svg'),
('水平拉', '桌下反向划船', '徒手', '训练背部、肩胛控制和手臂拉力，是徒手水平拉的经典动作。', '仰卧在稳固桌边下方，双手抓住桌沿|身体保持直线，脚跟踩地|肩胛先向后收，再把胸口拉向桌沿|慢慢下降回到起始位', '桌子必须稳固可靠|不要耸肩拉脖子|身体越水平难度越高，可调整脚的位置', '/exercise-guides/inverted-row.svg');
